...
begin
  ...
  lemma neg_lit_inj_simp[simp]: "neg_lit l = neg_lit l' \<longleftrightarrow> l=l'" by (cases l; cases l') auto

  lemma neg_lit_eq_inv[simp]:
    "neg_lit l = Neg v \<longleftrightarrow> l = Pos v"  
    "Neg v = neg_lit l \<longleftrightarrow> l = Pos v"  
    "neg_lit l = Pos v \<longleftrightarrow> l = Neg v"  
    "Pos v = neg_lit l \<longleftrightarrow> l = Neg v"  
